...
!function (A) {
	...
	106: function (A, e, t) {
		...
		e.read = function (A, e, t, r, o) {
			var n, i, s = 8 * o - r - 1, a = (1 << s) - 1, l = a >> 1, c = -7, u = t ? o - 1 : 0, g = t ? -1 : 1,
				f = A[e + u];
			...
			var i, s, a, l = 8 * n - o - 1, c = (1 << l) - 1, u = c >> 1, g = 23 === o ? 5.960464477539062e-8 : 0,
				f = r ? 0 : n - 1, d = r ? 1 : -1, p = 0 > e || 0 === e && 0 > 1 / e ? 1 : 0;
		...
		(function (A) {
			...
			function l(A, e) {
				if (s(e), A = o(A, 0 > e ? 0 : 0 | d(e)), !n.TYPED_ARRAY_SUPPORT)for (var t = 0; t < e; ++t)A[t] = 0;
				return A
			}
			...
			function E(A, e, t, r, o) {
				...
				if (o) {
					var c = -1;
					for (l = t; l < s; l++)if (n(A, l) !== n(e, -1 == c ? 0 : l - c)) -1 != c && (l -= l - c), c = -1; else if (-1 == c && (c = l), l - c + 1 === a)return c * i
				} else for (t + a > s && (t = s - a), l = t; 0 <= l; l--) {
					for (var u = !0, g = 0; g < a; g++)if (n(A, l + g) !== n(e, g)) {
						u = !1;
						break
					}
					if (u)return l
			...
			e.Buffer = n, e.SlowBuffer = function (A) {
				...
				if (A === e)return 0;
				for (var t = A.length, r = e.length, o = 0, i = _Mathmin(t, r); o < i; ++o)if (A[o] !== e[o]) {
					t = A[o], r = e[o];
					break
				}
				...
				for (var i = o - r, s = t - e, a = _Mathmin(i, s), l = this.slice(r, o), c = A.slice(e, t), u = 0; u < a; ++u)if (l[u] !== c[u]) {
					i = l[u], s = c[u];
					break
				}
				...
				if (void 0 === e) r = "utf8", t = this.length, e = 0; else if (void 0 === t && "string" == typeof e) r = e, t = this.length, e = 0; else {
			...
			n.prototype.slice = function (A, e) {
				...
				var r;
				if (n.TYPED_ARRAY_SUPPORT) r = this.subarray(A, e), r.__proto__ = n.prototype; else {
					var o = e - A;
					r = new n(o, void 0);
				...
				var o, i = r - t;
				if (this === A && t < e && e < r)for (o = i - 1; 0 <= o; --o)A[o + e] = this[o + t]; else if (1e3 > i || !n.TYPED_ARRAY_SUPPORT)for (o = 0; o < i; ++o)A[o + e] = this[o + t]; else Uint8Array.prototype.set.call(A, this.subarray(t, t + i), e);
				return i
				...
				var i;
				if ("number" == typeof A)for (i = e; i < t; ++i)this[i] = A; else {
					var s = n.isBuffer(A) ? A : O(new n(A, r).toString()), a = s.length;
		...
		function n(A, e) {
			...
			var r = E[E.length - 1];
			if ("top" === A.insertAt) r ? r.nextSibling ? t.insertBefore(e, r.nextSibling) : t.appendChild(e) : t.insertBefore(e, t.firstChild), E.push(e); else {
		...
		function u(A, e, t, r) {
			var o = t ? "" : r.css;
			if (A.styleSheet) A.styleSheet.cssText = b(e, o); else {
		...
		function f(A, e, t) {
			var r = t.css, o = t.sourceMap, n = void 0 === e.convertToAbsoluteUrls && o;
		...
		e.defaultOptions = {
			...
			preloaded: {
				"en-US": {
					...
					rows: "Rows",
					save: "Save",
					selectOptions: "Options (content code)",
					select: "Select",
		...
		Object.defineProperty(e, "__esModule", {value: !0});
		var i = t(33), s = t(113), a = t(19), l = r(a), c = t(52), u = r(c), g = t(34), f = r(g), d = t(112), p = t(6),
			h = r(p), B = d.config.opts, w = l.default.markup, E = function () {
				function A(e, t) {
				...
				return A.prototype.startMoving = function (A, e) {
					...
					var t = this, r = d.config.opts, o = t.d.stage, n = o.childNodes.length - 1, i = [];
					...
					return t.each(function (A) {
						var r = $(t[A]), o = $(".option-selected", r).is(":checked"),
					...
					return l.default.forEach(e, function (A, e) {
						...
						if (e.type.match(o)) {
							for (var n = e.values, s = [], a = 0; a < n.length; a++) {
								var l = n[a], c = w("option", l.label, l).outerHTML;
								s.push("\n\t\t\t" + c)
							}
					...
					l.default.forEach(t, function (A) {
						var r, o = t[A], n = l.default.camelCase(o.getAttribute("name"));
					...
					if (t) {
						var r = void 0, o = e.type, n = e.style, i = t.value.split(" "),
					...
					var t = 2 < arguments.length && void 0 !== arguments[2] && arguments[2],
						...
						s = w("button", n.yes, {className: "yes btn btn-success btn-sm"}),
						a = w("button", n.no, {className: "no btn btn-danger btn-sm"});
					a.onclick = function () {
						o.closeConfirm(i)
					}, s.onclick = function () {
						e(), o.closeConfirm(i)
					};
					var l = w("div", [a, s], {className: "button-wrap"});
					r = "form-builder-dialog " + r;
					var c = w("div", [A, l], {className: r});
					...
					var e = 1 < arguments.length && void 0 !== arguments[1] && arguments[1],
						t = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : "", r = this,
					...
					var e = this, t = A.target.id.match(/frmb-\d{13}/)[0], r = document.getElementById(t),
					...
					var e = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1],
						t = document.getElementById(A), r = $(".toggle-form", t), o = $(".frm-holder", t);
					...
					var A = this.d, e = $(A.controls).parent(), t = $(A.stage).parent(), r = e.width(),
					...
					$(window).scroll(function (n) {
						...
						if (i > t.offset().top) {
							var l = Object.assign({position: "fixed", width: r}, a), c = e.offset(), u = t.offset(),
								g = c.top + e.height(), f = u.top + t.height(), p = g === f && c.top > i;
					...
					var A = this.data, e = l.default.escapeHtml(A.formData),
						t = w("code", e, {className: "formData-" + d.config.opts.dataType});
					this.dialog(w("pre", t), null, "data-dialog")
				}, A.prototype.removeField = function (A) {
					var e = !1, t = this, r = this.d.stage, o = r.getElementsByClassName("form-field");
					...
					var e = A.label, t = A.events, r = o(A, ["label", "events"]), n = this.data;
					...
					A.stage = w("ul", null, {
						id: e.formID,
						className: "frmb"
					}), A.controls = w("ul", null, {id: e.formID + "-control-box", className: "frmb-control"})
					...
					var e = this, t = [{
						...
						id: "save", type: "button", className: "btn btn-primary save-template", events: {
							click: function (A) {
								e.save(), d.config.opts.onSave(A, e.data.formData)
							}
						}
					}];
					return d.config.opts = Object.assign({}, {actionButtons: t}, A), d.config.opts
		...
		var r = t(329);
		"string" == typeof r && (r = [[A.i, r, ""]]), t(110)(r, {attrs: {class: "formBuilder-injected-style"}}), r.locals && (A.exports = r.locals)
	}, 146: function (A, e, t) {
		"use strict";
		function r(A) {
			return A && A.__esModule ? A : {default: A}
		...
		t(58), t(144);
		var i = t(33), s = r(i), a = t(113), l = t(34), c = r(l), u = t(19), g = r(u), f = t(52), d = r(f), p = t(57),
			h = r(p), B = t(142), w = r(B), E = t(112), y = t(6), b = r(y);
		t(56);
		var M = t(46), I = r(M), m = (new Date).getTime(), Q = function A(e, t) {
			function r(A, e) {
				var t = [];
				for (var r in A)if (A.hasOwnProperty(r)) {
					var n = p[r], i = A[r], s = i.value;
					i.value = e[r] || i.value || "", i.label && (p[r] = i.label), i.options ? t.push(l(r, i)) : t.push(o(r, i)), p[r] = n, i.value = s
				}
				return t.join("")
			}
			...
			var C = new w.default(B, Q), D = g.default.markup, v = e;
			b.default.loadCustom(e.controls), Object.keys(e.fields).length && I.default.register(e.templates, e.fields), e = C.processOptions(e);
			var x = E.config.subtypes = C.processSubtypes(e.subtypes);
			C.editorUI(B);
			var Y = $(M.stage);
			y.layout = C.editorLayout(e.controlPosition), y.formID = B, y.lastID = y.formID + "-fld-1";
			var N = b.default.getRegistered();
			N = C.orderFields(N), e.disableFields && (N = N.filter(function (A) {
				return -1 == e.disableFields.indexOf(A)
			})), e.sortableControls && M.controls.classList.add("sort-enabled");
			for (var j = $(M.controls), F = 0, T = N, R = Array.isArray(T), L = 0, T = R ? T : T[Symbol.iterator](); ;) {
				var U;
				if (R) {
					if (L >= T.length)break;
					U = T[L++]
				} else {
					if (L = T.next(), L.done)break;
					U = L.value
				}
				var G = U, S = b.default.getClass(G);
				if (S && S.active(G)) {
					var k = S.icon(G), z = S.label(G), P = k ? "" : "icon-" + G;
					k && (z = '<span class="control-icon">' + k + "</span>" + z);
					var O = D("li", D("span", z), {className: P + " input-control input-control-" + F});
					O.dataset.type = G, M.controls.appendChild(O), F++
				}
			}
			e.inputSets.length && ($("<li/>", {class: "fb-separator"}).html("<hr>").appendTo(j), e.inputSets.forEach(function (A, e) {
				A.name = A.name || g.default.makeClassName(A.label);
				var t = D("li", A.label, {className: "input-set-control input-set-" + e, type: A.name});
				$(t).appendTo(j)
			})), Y.sortable({
				cursor: "move",
				opacity: .9,
				...
				distance: 3,
				update: function (A, t) {
					return !C.doCancel && void(t.item.parent()[0] === M.stage ? (C.doCancel = !0, J(t.item)) : (C.setFieldOrder(j), C.doCancel = !e.sortableControls))
				}
			});
			var J = function (A) {
			...
			H.append(K, V), "textarea" === t.type ? $(t).replaceWith(H) : $(t).append(H);
			...
			var _ = function () {
				var A = [], t = function (A) {
					return g.default.markup("li", e[A], {className: "disabled-field form-" + A})
				};
				return e.prepend && !$(".disabled-field.form-prepend", M.stage).length && (A.push(!0), Y.prepend(t("prepend"))), e.append && !$(".disabled-field.form-.append", M.stage).length && (A.push(!0), Y.append(t("append"))), C.disabledTT(M.stage), A.some(function (A) {
					return !0 === A
				})
			}, AA = function (A) {
				...
				i && (t.style = i[1]), uA(t, e), e && document.dispatchEvent(d.default.fieldAdded), K.classList.remove("empty")
			}, eA = function (A) {
				if ((A = C.getData(A)) && A.length) {
					for (var t, r = 0; r < A.length; r++)t = g.default.trimObj(A[r]), AA(t);
					K.classList.remove("empty")
				} else e.defaultFields && e.defaultFields.length ? (e.defaultFields.forEach(function (A) {
					return AA(A)
				}), K.classList.remove("empty")) : e.prepend || e.append || (K.classList.add("empty"), K.dataset.content = p.getStarted);
				_() && K.classList.remove("empty"), C.save()
			}, tA = function (A) {
				var e = A.type, t = A.values, r = A.name,
					...
					i = A.multiple || "checkbox-group" === e, s = function (A) {
						var t = {label: A, value: g.default.hyphenCase(A)};
				...
				var t = A.type, o = [], n = rA(t), i = {
					required: function () {
						...
						for (s in e.roles)if (e.roles.hasOwnProperty(s)) {
							...
							g.default.inArray(s, a) && (n.checked = "checked"), r.push('<label for="' + o + '">'), r.push(C.input(n).outerHTML), r.push(" " + e.roles[s] + "</label>")
						}
						r.push("</div>");
				...
				var r = function (e) {
					return D("label", e, {for: A + "-" + y.lastID}).outerHTML
				}, o = {type: "checkbox", className: "fld-" + A, name: A, id: A + "-" + y.lastID};
				e[A] && (o.checked = !0);
				var n = [], i = [D("input", null, o).outerHTML];
				return t.first && n.push(r(t.first)), t.second && i.push(" ", r(t.second)), t.content && i.push(t.content), i = D("div", i, {className: "input-wrap"}).outerHTML, D("div", n.concat(i), {className: "form-group " + A + "-wrap"}).outerHTML
			}, iA = function (A) {
				var e = p.styles.btn, t = "";
				if (e) {
					var r = "<label>" + p.style + "</label>";
					t += C.input({
						value: A,
						name: A,
						type: "hidden",
						...
						A === e && r.push("selected");
						var o = D("button", p.styles.btn[e], {
							value: e,
							type: "button",
							className: r.join(" ")
						}).outerHTML;
						t += o
					}), t += "</div>", t = D("div", [r, t], {className: "form-group style-wrap"})
				}
				return t.outerHTML
			}, sA = function (A, e) {
				var t = e[A], r = p[A] || A, o = p["placeholder." + A], n = {
					type: "number",
					value: t,
					name: A,
					min: "0",
				...
				var r = t.map(function (t, r) {
						...
						return t.value === e[A] && (o.selected = !0), o = g.default.trimObj(o), D("option", o.label, o)
				...
				var t = e[A] || "", r = p[A];
				"label" === A && (g.default.inArray(e.type, ["paragraph"]) ? r = p.content : t = g.default.parsedHtml(e[A]));
				...
				if (![].some(function (A) {
					...
					"label" === A ? (i.contenteditable = !0, n += D("div", t, i).outerHTML) : (i.value = t, i.type = "text", n += "<input " + g.default.attrString(i) + ">");
				...
				var t = !(1 < arguments.length && void 0 !== arguments[1]) || arguments[1], r = A.type || "text",
				...
				}), C.updatePreview(f), e.typeUserEvents[r] && e.typeUserEvents[r].onadd && e.typeUserEvents[r].onadd(u), e.editOnAdd && t && (C.closeAllEdit(), C.toggleEdit(y.lastID, !1)), y.lastID = C.incrementId(y.lastID)
			}, gA = function (A, e, t) {
				var r = {selected: t ? "checkbox" : "radio"}, o = ["value", "label", "selected"], n = [];
				e = Object.assign({selected: !1, label: "", value: ""}, e);
				for (var i, s = o.length - 1; 0 <= s; s--)if (i = o[s], e.hasOwnProperty(i)) {
					var a = {type: r[i] || "text", className: "option-" + i, value: e[i], name: A + "-option"};
				...
				var t = A.attr("id"), r = A.attr("type"), o = (new Date).getTime(), n = r + "-" + o, i = A.clone();
				return $(".fld-name", i).val(n), i.find("[id]").each(function (A, e) {
					e.id = e.id.replace(t, y.lastID)
				}), i.find("[for]").each(function (A, e) {
					var r = e.getAttribute("for"), o = r.replace(t, y.lastID);
					e.setAttribute("for", o)
				}), i.attr("id", y.lastID), i.attr("name", n), i.addClass("cloned"), $(".sortable-options", i).sortable(), e.typeUserEvents[r] && e.typeUserEvents[r].onclone && e.typeUserEvents[r].onclone(i[0]), y.lastID = C.incrementId(y.lastID), i
			};
			if (Y.on("click touchstart", ".remove", function (A) {
					var t = $(A.target).parents(".form-field:eq(0)"), r = t[0], o = r.getAttribute("type"),
						n = $(A.target.parentElement);
					A.preventDefault(), 2 >= r.querySelector(".sortable-options").childNodes.length && !o.includes("checkbox") ? e.notify.error("Error: " + p.minOptionMessage) : n.slideUp("250", function () {
					...
					A.preventDefault();
					var e = $(A.target).parent().parent("li"), t = fA(e);
					t.insertAfter(e), C.updatePreview(t), C.save.call(C)
				}), Y.on("click touchstart", ".delete-confirm", function (A) {
					A.preventDefault();
					var t = A.target.getBoundingClientRect(), r = document.body.getBoundingClientRect(),
					...
					var e = $(A.target).closest(".field-options"), t = $('[name="multiple"]', e),
						r = $(".option-selected:eq(0)", e), o = !1;
					o = t.length ? t.prop("checked") : "checkbox" === r.attr("type");
					var n = r.attr("name");
					$(".sortable-options", e).append(gA(n, !1, o))
				}), Y.on("mouseover mouseout", ".remove, .del-button", function (A) {
					return $(A.target).closest("li").toggleClass("delete")
				}), eA(), Y.css("min-height", j.height()), e.stickyControls.enable && C.stickyControls(Y), e.disableInjectedStyle) {
			...
			return document.dispatchEvent(d.default.loaded), f.actions = {
				clearFields: function (A) {
					...
					C.stopIndex = y.formData.length ? e : void 0, AA(A), document.dispatchEvent(d.default.fieldAdded)
					...
					var e = n(regeneratorRuntime.mark(function e(r) {
						...
						return regeneratorRuntime.wrap(function (e) {
							for (; ;)switch (e.prev = e.next) {
								...
								case 2:
									M.empty(t), o = new A(v, t), $(t).data("formBuilder", o);
								case 5:
								case"end":
									return e.stop()
							}
		...
		!function (A) {
			A.fn.formBuilder = function (e) {
				e || (e = {});
				var t = this, r = A.extend({}, E.defaultOptions, e, !0), n = r.i18n, i = o(r, ["i18n"]);
				E.config.opts = i;
		...
		window.fbLoaded = {js: [], css: []}, window.fbEditors = {quill: {}, tinymce: {}}, i.inArray = function (A, e) {
			...
			return {className: "class"}[A] || i.hyphenCase(A)
			...
			var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : "",
				t = 2 < arguments.length && void 0 !== arguments[2] ? arguments[2] : {}, o = i.contentType(e),
				n = t.events, s = r(t, ["events"]), a = document.createElement(A), l = {
					string: function (A) {
						a.innerHTML += A
					}, object: function (A) {
						var e = A.tag, t = A.content, o = r(A, ["tag", "content"]);
		...
		i.parseAttrs = function (A) {
			...
			if (t)for (var o = t.getElementsByTagName("field"), n = 0; n < o.length; n++) {
				var s = i.parseAttrs(o[n]), a = o[n].getElementsByTagName("option");
			...
			var e = A.label, t = void 0 === e ? "" : e, o = A.description, n = void 0 === o ? "" : o,
				a = r(A, ["label", "description"]), l = i.parsedHtml(t), c = [l];
			a.required && c.push(s("span", " *", {className: "fb-required"})), "hidden" !== a.type && n && c.push(s("span", "?", {
				className: "tooltip-element",
				tooltip: n
			}));
			var u = {className: "fb-" + a.type + "-label"};
			...
			var e = A.values, t = A.type, o = r(A, ["values", "type"]), i = function (A) {
				var e = A.target.nextSibling.nextSibling, t = e.getElementsByClassName("active-option")[0],
			...
			}), l = Object.assign({}, o, {type: "hidden"});
			delete a.name;
			var c = [s("input", null, a), s("input", null, l)], u = e.map(function (A) {
				var e = A.label, t = {
					events: {
						click: function (e) {
							var t = e.target.parentElement, r = t.previousSibling.previousSibling;
			...
			return c.push(s("ul", u, {id: o.id + "-list", className: "fb-" + t + "-list"})), {
				field: c,
				onRender: function () {
				}
			}
		}, i.selectTemplate = function (A, e) {
			var t = [], o = A.values, n = A.type, a = A.inline, l = A.other, c = A.toggle,
				u = r(A, ["values", "type", "inline", "other", "toggle"]), g = i.processFieldDataAttrs(u, e),
				f = n.replace("-group", ""), d = "select" === n;
			if (o) {
				g.placeholder && d && t.push(s("option", g.placeholder, {disabled: null, selected: null}));
				for (var p = 0; p < o.length; p++) {
					var h = o[p], B = h.label, w = void 0 === B ? "" : B, E = r(h, ["label"]);
					if (E.id = g.id + "-" + p, (!E.selected || g.placeholder) && delete E.selected, d) {
						...
						var M = s("input", null, Object.assign({}, g, E)), I = {for: E.id}, m = [M, w];
						if (c) {
							m = [M, s("span"), w], I.className = "kc-toggle"
						}
						var Q = s("label", m, I), C = s("div", Q, {className: b});
						t.push(C)
					}
				}
				if (!d && l) {
					var D = {
						id: g.id + "-other", className: g.className + " other-option", events: {
							click: function () {
					...
					x.type = f;
					var Y = {type: "text", name: u.name, id: D.id + "-value", className: "other-val"},
						N = [s("input", null, x), document.createTextNode("Other"), s("input", null, Y)],
						j = s("label", N, {for: x.id}), F = s("div", j, {className: v});
					t.push(F)
				}
			}
			return "select" === n ? s(f, t, u) : s("div", t, {className: n})
		}, i.defaultField = function (A) {
			var e = A.label, t = A.description, o = A.subtype, n = A.type, a = A.id, l = A.isPreview,
			...
			var u = {field: s(n, i.parsedHtml(e), c), onRender: i.noop};
			return function () {
				return u
			}
			...
			var e = A.value, t = void 0 === e ? "" : e, o = r(A, ["value"]),
				n = {field: s("textarea", i.parsedHtml(t), o)}, a = {
					tinymce: {
						js: ["//cdn.tinymce.com/4/tinymce.min.js"], onRender: function () {
		...
		}, i.templates = [["autocomplete", function (A) {
			var e = i.processFieldDataAttrs(A), t = i.makeLabel(A), r = i.autocompleteTemplate(e);
			return {field: [t, r.field], onRender: r.onRender}
		}], [n.defaultSubtypes.text.concat(["number", "file", "date"]), function (A) {
			var e = i.processFieldDataAttrs(A);
			return {field: [i.makeLabel(A), s("input", null, e)]}
		}], [["paragraph"].concat(n.defaultSubtypes.paragraph), function (A) {
			var e = i.processFieldDataAttrs(A);
			return {field: [s(A.type, i.parsedHtml(A.label), e)]}
		}], [n.defaultSubtypes.button, function (A) {
			var e = i.processFieldDataAttrs(A);
			return {field: s("button", A.label, e)}
		}], [["select", "checkbox-group", "radio-group", "checkbox"], function (A) {
			return {field: [i.makeLabel(A), i.selectTemplate(A)]}
		}], [["textarea", "tinymce", "quill"], function (A) {
			var e = i.processFieldDataAttrs(A), t = i.longTextTemplate(e);
			return {field: [i.makeLabel(A), t.field], onRender: t.onRender}
		}]], i.processFieldDataAttrs = function (A) {
			var e = A.subtype, t = r(A, ["subtype"]);
		...
		A.exports = function (A) {
			...
			var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (A) {
				...
				return A.prototype.getValue = function (A) {
					...
					var t, r = this, n = this.getValue(A), i = n.match(/\{[^\}]+?\}/g);
					if (e && i)if ("object" === (void 0 === e ? "undefined" : o(e)))for (var s = 0; s < i.length; s++)t = i[s].substring(1, i[s].length - 1), n = n.replace(r.makeSafe(i[s]), e[t] || ""); else n = n.replace(/\{[^\}]+?\}/g, e);
					return n
					...
					return new Promise(function (t, r) {
						if (e.langs[A]) t(e.langs[A]); else {
							var o = new XMLHttpRequest, n = e.config.location + A + e.config.extension;
		...
		}(), a = t(6), l = r(a), c = t(34), u = r(c), g = function (A) {
			function e() {
				return o(this, e), n(this, A.apply(this, arguments))
			}
		...
		Object.defineProperty(e, "__esModule", {value: !0});
		var o = t(71), n = r(o), i = t(72), s = r(i), a = t(46), l = r(a), c = t(73), u = r(c), g = t(74), f = r(g),
			d = t(75), p = r(d), h = t(76), B = r(h), w = t(35), E = r(w), y = t(78), b = r(y), M = t(77), I = r(M);
		e.default = {
		...
		var o = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (A) {
			...
			function A(e, t) {
				...
				r(this, A), this.preview = t, this.templates = {
					label: null, help: null, default: function (A, e, t, r) {
						...
						return o.markup("div", [e, A], {className: n})
			...
			return A.prototype.configure = function () {
				...
				var r = new A(e, this.preview), n = r.build();
		...
		(function (e, t) {
			!function (e) {
				"use strict";
				function r(A, e, t, r) {
					var o = Object.create((e || n).prototype), i = new d(r || []);
				...
				function c(A) {
					...
					var r, o = e.bind(A, "next"), n = e.bind(A, "throw");
					e.bind(A, "return");
				...
				function u(A, e, t) {
					...
					return function (n, i) {
						...
						for (; ;) {
							...
							if ("next" === n) t._sent = i, t.sent = r == I ? i : B; else if ("throw" === n) {
								if (r == M)throw r = Q, i;
					...
					if (A) {
						...
						if (!isNaN(A.length)) {
							var t = -1, r = function e() {
								for (; ++t < A.length;)if (w.call(A, t))return e.value = A[t], e.done = !1, e;
				...
				i.prototype = D.constructor = s, s.constructor = i, i.displayName = "GeneratorFunction", b.isGeneratorFunction = function (A) {
					...
					constructor: d, reset: function (A) {
						if (this.prev = 0, this.next = 0, this.sent = B, this.done = !1, this.delegate = null, this.tryEntries.forEach(f), !A)for (var e in this)"t" === e.charAt(0) && w.call(this, e) && !isNaN(+e.slice(1)) && (this[e] = B)
					}, stop: function () {
						this.done = !0;
						...
						for (var t, r = this.tryEntries.length - 1; 0 <= r; --r)if (t = this.tryEntries[r], t.tryLoc <= this.prev && w.call(t, "finallyLoc") && this.prev < t.finallyLoc) {
							var o = t;
							break
						}
						...
						for (var e, t = this.tryEntries.length - 1; 0 <= t; --t)if (e = this.tryEntries[t], e.finallyLoc === A)return this.complete(e.completion, e.afterLoc), f(e), C
					}, catch: function (A) {
		...
		var i = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function (A) {
		...
		}(), a = t(19), l = r(a), c = t(34), u = r(c), g = function () {
			function A(e, t) {
				...
				this.classConfig = A.controlConfig[c] || {}, this.subtype && (e.type = this.subtype), this.required && (e.required = "required", e["aria-required"] = "true"), this.config = e, this.configure()
			}
			...
			return A.register = function (e, t, r) {
				...
				for (var n = e, i = Array.isArray(n), s = 0, n = i ? n : n[Symbol.iterator](); ;) {
					...
					var l = a;
					-1 < l.indexOf(".") ? A.error("Ignoring type " + l + ". Cannot use the character '.' in a type name.") : A.classRegister[o + l] = t
				}
				...
				if (n)return n;
				var s = t.mi18n;
				return "object" === (void 0 === s ? "undefined" : i(s)) && (s = s[o] || s[A]), s || (s = o), u.default.get(s, e)
			}, A.active = function (A) {
		...
		var s = t(6), a = function (A) {
			return A && A.__esModule ? A : {default: A}
		}(s), l = t(33), c = function (A) {
			function e() {
				return o(this, e), n(this, A.apply(this, arguments))
			}

			return i(e, A), e.prototype.build = function () {
				var A = this, e = this.config, t = e.values, o = e.type, n = r(e, ["values", "type"]),
					i = function (A) {
						var e = A.target.nextSibling.nextSibling, t = e.getElementsByClassName("active-option")[0],
							r = new Map([[38, function () {
								t && t.previousSibling && (t.classList.remove("active-option"), t = t.previousSibling, t.classList.add("active-option"))
				...
				delete s.name;
				var c = [this.markup("input", null, s), this.markup("input", null, a)], u = t.map(function (e) {
					var t = e.label, r = {
						events: {
							click: function (A) {
								var t = A.target.parentElement, r = t.previousSibling.previousSibling;
		...
		Object.defineProperty(e, "__esModule", {value: !0});
		var a = t(6), l = r(a), c = t(19), u = r(c), g = function (A) {
			function e() {
		...
		var s = function () {
			...
			return i(e, A), e.prototype.build = function () {
				var A = this, e = [], t = this.config, o = t.values, n = t.value, i = t.placeholder, s = t.type,
				...
				if ((u.multiple || "checkbox-group" === s) && (u.name += "[]"), "checkbox-group" === s && u.required && (this.onRender = this.groupRequired), delete u.title, o) {
					i && f && e.push(this.markup("option", i, {disabled: null, selected: null}));
				...
				return "select" == s ? this.markup(g, e, u) : this.markup("div", e, {className: s})
			}, e.prototype.groupRequired = function () {
				var A = this.element.getElementsByTagName("input"), e = l.default.mi18n("minSelectionRequired", 1),
					t = function (A, t) {
